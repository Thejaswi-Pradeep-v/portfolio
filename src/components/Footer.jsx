    ...
    <footer className="py-8 text-center border-t border-slate-800/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex gap-6">
          ...
          <a href="mailto:thejaswipradeep11a@gmail.com" className="text-slate-500 hover:text-blue-400 transition-colors">
            <Mail size={20} />
          </a>
        </div>
        
        <p className="text-slate-500 text-sm">
          Designed & Built by <span className="text-slate-300">Thejaswi Pradeep</span>
        </p>
      </div>
    </footer>
  );
